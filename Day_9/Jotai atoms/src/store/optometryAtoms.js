...
export const rightEyeSphereAtom = atom(-1.50); // قياس العين اليمنى
export const leftEyeSphereAtom = atom(-2.00);  // قياس العين اليسرى
export const isCylinderRequiredAtom = atom(false); // هل يحتاج عدسة انحراف؟

// 2. DERIVED ATOMS (The Excel Formulas of React! 🧠✨):
