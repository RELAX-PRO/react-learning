...
// Importing pre-built accessible primitives (Simulating a modern UI library like shadcn/ui or Radix UI):
import { 
  Dialog, 
  DialogTrigger, 
  DialogContent, 
...
const OpticalArchiveDialog = ({ patientName, patientId, onConfirmArchive }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      {/* The Trigger Button: Automatically handles accessibility and click events */}
      ...
      {/* The Modal Content: Comes with built-in backdrop blur, Escape key close, and focus management */}
