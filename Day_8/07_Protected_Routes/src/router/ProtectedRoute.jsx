...
const ProtectedRoute = () => {
  ...
  // 3. CAPTURE THE ATTEMPTED URL (UX Secret Weapon ðŸ§ ):
  const location = useLocation();

  if (!isAuthenticated) {
    console.warn("ðŸ›‘ Unauthorized access attempt detected! Redirecting to login...");
    
    // 4. INSTANT KICK-OUT:
    // We redirect to "/login".
    // PRO-TIP: "replace" prevents the intruder from pressing browser 'Back ðŸ”™' to get inside!
