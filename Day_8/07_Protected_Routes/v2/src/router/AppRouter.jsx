...
import UnauthorizedView from '../views/UnauthorizedView'; // ðŸ‘ˆ 403 Screen
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* --- ðŸ”µ TIER 1: GENERAL EMPLOYEES (Doctors + Receptionists) --- */}
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/" element={<MainLayout />}>
            ...
            {/* --- ðŸ”´ TIER 2: TOP SECRET ZONE (Admins & Doctors ONLY!) --- */}
