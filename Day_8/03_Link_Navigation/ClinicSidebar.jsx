  ...
  return (
    <aside className="w-64 bg-slate-950 border-r border-slate-800 p-6 flex flex-col justify-between min-h-screen font-mono text-white">
      ...
      <div>
        ...
        {/* Navigation Menu - Using <NavLink> for active styling */}
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-xs transition cursor-pointer ${
                isActive
                  ? "bg-blue-600 text-white shadow-lg shadow-blue-600/30" // ðŸ‘ˆ Active UI state
                  : "text-slate-400 hover:bg-slate-900 hover:text-slate-200" // ðŸ‘ˆ Inactive UI state
              }`
            }
          >
            <span>ðŸ“Š</span>
